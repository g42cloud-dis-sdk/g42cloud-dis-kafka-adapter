 ...
 */
package com.g42cloud.dis.adapter.kafka.clients.producer;

import com.g42cloud.dis.Constants;
import com.g42cloud.dis.DISConfig;
import com.g42cloud.dis.adapter.common.Utils;
import com.g42cloud.dis.adapter.common.model.DisProducerRecord;
import com.g42cloud.dis.adapter.common.model.ProduceCallback;
import com.g42cloud.dis.adapter.common.producer.DISProducer;
import com.g42cloud.dis.adapter.common.producer.DisProducerConfig;
import com.g42cloud.dis.adapter.common.producer.IDISProducer;
import com.g42cloud.dis.adapter.kafka.clients.consumer.OffsetAndMetadata;
...
import com.g42cloud.dis.adapter.kafka.common.serialization.Serializer;
import com.g42cloud.dis.adapter.kafka.common.serialization.StringSerializer;
 ...
 * props.put(ProducerConfig.PROPERTY_ENDPOINT, &quot;https://dis.cn-north-1.myg42cloud.com&quot;);
 * props.put(ProducerConfig.LINGER_MS_CONFIG, 50);
 * props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, "com.g42cloud.dis.adapter.kafka.common.serialization.StringSerializer");
 * props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "com.g42cloud.dis.adapter.kafka.common.serialization.StringSerializer");
 *
 ...
 * their <code>ProducerRecord</code> into bytes. You can use the included {@link com.g42cloud.dis.adapter.kafka.common.serialization.ByteArraySerializer} or
 * {@link com.g42cloud.dis.adapter.kafka.common.serialization.StringSerializer} for simple string or byte types.
 * <p>
 */
