...
import com.g42cloud.dis.adapter.common.consumer.DISConsumer;
import com.g42cloud.dis.adapter.common.consumer.DisConsumerConfig;
import com.g42cloud.dis.adapter.common.consumer.DisNoOpDisConsumerRebalanceListener;
import com.g42cloud.dis.adapter.common.consumer.DisOffsetAndTimestamp;
import com.g42cloud.dis.adapter.common.model.StreamPartition;
import com.g42cloud.dis.adapter.kafka.clients.ConvertUtils;
import com.g42cloud.dis.adapter.kafka.common.TopicPartition;
import com.g42cloud.dis.adapter.kafka.common.PartitionInfo;
import com.g42cloud.dis.adapter.kafka.common.Node;
import com.g42cloud.dis.adapter.kafka.common.Metric;
import com.g42cloud.dis.adapter.kafka.common.MetricName;
import com.g42cloud.dis.adapter.kafka.common.record.TimestampType;
import com.g42cloud.dis.adapter.kafka.common.serialization.Deserializer;
import com.g42cloud.dis.adapter.kafka.common.serialization.StringDeserializer;
 ...
 *     props.put(ConsumerConfig.PROPERTY_ENDPOINT, &quot;https://dis.cn-north-1.myg42cloud.com&quot;);
 *     props.put(ConsumerConfig.GROUP_ID_CONFIG, &quot;test&quot;);
 *     props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, &quot;true&quot;);
 *     props.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, &quot;1000&quot;);
 *     props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, &quot;com.g42cloud.dis.adapter.kafka.common.serialization.StringDeserializer&quot;);
 *     props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, &quot;com.g42cloud.dis.adapter.kafka.common.serialization.StringDeserializer&quot;);
 ...
 * </pre>
 *
 * Setting <code>ak</code>/<code>sk</code> is the authentication information of your G42 cloud account,
 * <code>projectId</code> is a collection of resources in your designated <code>region</code> of G42 cloud, you can
 * get those by visiting <a href="https://console.g42cloud.com/iam/?region=cn-north-1&locale=zh-cn#/myCredential">My Credentials Page</a>.
 * <p>
 * Setting <code>endpoint</code> is used to connection to the DIS, different <code>region</code> has different <code>endpoint</code>,
 * you can get it by visiting <a href="https://developer.g42cloud.com/endpoint?DIS">Regions and Endpoints Page</a>.
 * <p>
