 ...
 * the topic.
 * <li>
 * If the topic is configured to use {@link com.g42cloud.dis.adapter.kafka.common.record.TimestampType#CREATE_TIME CreateTime},
 * the timestamp in the producer record will be used by the broker.
 * </li>
 * <li>
 * If the topic is configured to use {@link com.g42cloud.dis.adapter.kafka.common.record.TimestampType#LOG_APPEND_TIME LogAppendTime},
