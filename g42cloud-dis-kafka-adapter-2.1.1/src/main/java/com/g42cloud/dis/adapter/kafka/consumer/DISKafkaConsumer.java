...
package com.g42cloud.dis.adapter.kafka.consumer;
...
import com.g42cloud.dis.adapter.kafka.ConvertUtils;
...
public class DISKafkaConsumer<K, V> implements Consumer<K, V> {
    ...
    public void subscribe(Collection<String> collection) {
        disConsumer.subscribe(collection, new DisNoOpDisConsumerRebalanceListener());
    }
    ...
    public void assign(Collection<TopicPartition> collection) {
        disConsumer.assign(ConvertUtils.convert2StreamPartitionCollection(collection));
    }
